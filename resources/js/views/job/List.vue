<!-- File: resources/js/views/Job/List.vue -->
<template>
  <div class="app-container">
    ...
    <el-dialog :title="'Create new Job'" :visible.sync="formVisible">
...
const objectResource = new Resource('job');
...
export default {
  ...
  methods: {
    ...
    handleEditForm(id) {
      ...
      this.currentObject = this.list.find((Job) => Job.id === id);
      this.formVisible = true;
    },
    handleDelete(id, name) {
      this.$confirm(
        'This will permanently delete Job ' + name + '. Continue?',
        'Warning',
        {
